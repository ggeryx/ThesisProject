...
builder.Services.AddIdentityCore<IdentityUser>()
    ...
    .AddTokenProvider<DataProtectorTokenProvider<IdentityUser>>("Gateway")
...
builder.Services.AddDbContext<AuthServiceIdentityDbContext>(options =>
...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
    .AddJwtBearer(options => options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        IssuerSigningKey = new SymmetricSecurityKey(
            Encoding.UTF8.GetBytes("pvUTFv8Vzof04Ls6x4Eo2Fmny6lC24V1Dkm4oI1iGkJemDBuct5PpNYk"))
    });
